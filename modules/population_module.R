...
population_key_insights <- list(
  ...
  "16-19 yo in education" = "Large urban areas see the highest proportion of 16-19 year olds in education as of 2025 (74%) and remote small towns the lowest (62%).",
  "16-19 yo in employment" = "Remote small towns see the highest proportion of 16-19 year olds in employment as of 2025 (30%) and large urban areas the lowest (17%).",
  "16-19 yo in training" = "Other urban areas see the highest proportion of 16-19 year olds in training and other personal development as of 2025 (2.5%) and remote rural areas the lowest (1.4%).",
  ...
  "Positive destinations" = "The percentage of school leavers in positive destinations in Scotland at 9-month follow-up has increased steadily across Scotland between 2009-10 and 2023-24 (going from 86% to 93% in 2022). In 2023-24 remote rural areas had the highest percentage in positive destinations (95%) despite a drop of 1 percentage point from the previous year. Remote small towns had the lowest percentage in a positive destination (93%) despite a rise of 1 percentage point from the previous year.",
  ...
  output$population_data_summary <- renderUI({
    ...
    custom_insight <- 
      if(input$population_metric == "16-19 yo in education, employment, training"){
        if(input$selected_participation_status == "Education"){population_key_insights["16-19 yo in education"]}
        else if(input$selected_participation_status == "Employment"){population_key_insights["16-19 yo in employment"]}
        else if(input$selected_participation_status == "Training and Other Personal Development"){population_key_insights["16-19 yo in training"]}
      }
      else{population_key_insights[[input$population_metric]]}
    ...
    source_info <- switch(input$population_metric,
                          ...
                          "Positive destinations" = list(
                            text = "Summary statistics for Follow- Up Leaver Destinations, No. 7: 2025 Edition",
                            url = "https://www.gov.scot/publications/summary-statistics-for-follow-up-leaver-destinations-no-7-2025-edition/"
                          ),
                          "Primary School Literacy" = list(
