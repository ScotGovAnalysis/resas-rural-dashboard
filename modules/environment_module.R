...
# Static Key Insights for environment metrics
environment_key_insights <- list(
  "Percentage of household waste recycled" = "insight placeholder",
  
  "Renewable Electricity" = "insight placeholder",
  
  "Clean Seas" = "insight placeholder",
  
  "Biodiversity: Scottish species" = "insight placeholder",
  
  "Fresh water" = "insight placeholder",
  
  "Restored peatland" = "insight placeholder",
  
  "Biodiversity awareness" = "insight placeholder",
  
  "Rare and threatened species" = "insight placeholder",
  
  "Forests and woodlands" = "insight placeholder"
)

#  Notes for environment metrics
environment_notes <- list(
  "Percentage of household waste recycled" = "note placeholder",
  
  "Renewable Electricity" = "note placeholder",
  
  "Clean Seas" = "note placeholder",
  
  "Biodiversity: Scottish species" = "notes placeholder",
  
  "Fresh water" = "notes placeholder",
  
  "Restored peatland" = "notes placeholder",
  
  "Biodiversity awareness" = "notes placeholder",
  
  "Rare and threatened species" = "notes placeholder",
  
  "Forests and woodlands" = "notes placeholder"
)
...
# Load renewable electricity data 
load_renewable_electricity_data <- function() {
  filepath <- "environment/renewable_generation.xlsx"
  cat("Attempting to load renewable electricity data from:", filepath, "\n")
...
# Load peatland data
load_peatland_data <- function() {
  filepath <- "environment/peatland.xlsx"
  cat("Attempting to load peatland data from:", filepath, "\n")
...
environment_server <- function(id, values, parent_session = NULL) {
  ...
  observe({
    ...
    data_rows <- nrow(environment_values$processed_data)
    environment_values$data_status <- if(data_rows > 0) "Environment data loaded" else "No data available"
  ...
  output$environment_data_summary <- renderUI({
    ...
    if (nrow(environment_values$processed_data) == 0) {
    ...
    source_info <- switch(input$environment_metric,
                          "Percentage of household waste recycled" = list(
                            text = "Scottish Government - Household Waste Recycling",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          "Renewable Electricity" = list(
                            text = "Scottish Government - Renewable Electricity Generation", 
                            url = "https://www.gov.scot/publications/quarterly-energy-statistics-bulletins/"
                          ),
                          "Clean Seas" = list(
                            text = "Scottish Government - Clean Seas",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          "Biodiversity: Scottish species" = list(
                            text = "Scottish Government - Biodiversity Species",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          "Fresh water" = list(
                            text = "Scottish Government - Fresh Water Condition",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          "Restored peatland" = list(
                            text = "Scottish Government - Peatland Restoration",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          "Biodiversity awareness" = list(
                            text = "Scottish Government - Biodiversity Awareness",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          "Rare and threatened species" = list(
                            text = "Scottish Government - Rare and Threatened Species",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          "Forests and woodlands" = list(
                            text = "Scottish Government - Woodland Area",
                            url = "https://www.gov.scot/publications/scottish-environmental-statistics-online/"
                          ),
                          list(text = "Data Source", url = "#")
    )
